...
// here we will use this data outside the try block because , inside it will be shadowed by the response of api call which also has data variable
...
let final = updatedExperience.slice(0, index).concat(updatedExperience.slice(index + 1));
onChange(final)
}
...
<Plus  className='animate-pulse text-yellow-500 size-4' />
Add Experience
</button>
</div>
