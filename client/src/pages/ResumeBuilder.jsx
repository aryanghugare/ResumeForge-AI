...
import { ArrowLeftIcon, Briefcase, FileText, UserIcon , User, GraduationCap, FolderIcon , Sparkles , ChevronLeft , ChevronRight, Share2, Share2Icon, EyeIcon, EyeOffIcon , DownloadIcon } from 'lucide-react';
...
if(!data.resume) console.error("No resume data returned from server after visibility change.");
...
window.print() ;
  ...
  return (
   ...
   <div className='w-full flex items-center justify-between border-b border-gray-300 py-4 px-6'>
<Link to="/app" className='text-sm text-gray-600 hover:text-gray-800 transition-colors'> <ArrowLeftIcon className='size-4' /> Back to Dashboard </Link>
</div>
...
{/* Share and visibility toggle buttons */}
{
resumeData.public && (
...
{
resumeData.public ? (
<EyeIcon className='size-4'/> ) : (<EyeOffIcon className='size-4'/>)
}
