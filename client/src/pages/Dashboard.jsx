import { PlusIcon, UploadCloudIcon, UploadIcon, XIcon , EditIcon , DeleteIcon , Delete , Trash2, LoaderCircleIcon , UploadCloud} from 'lucide-react'
...
<button className='mt-4 px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition'>Create</button>
 ...
 {showUploadResume && (
          <form onSubmit={uploadResume} onClick={()=> {setShowUploadResume(false); setResume(null)}} className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-10 flex items-center justify-center'>
            <div onClick={e => e.stopPropagation()} className='relative bg-slate-50 border shadow-md rounded-lg w-full max-w-sm p-6'>
